...
//   const matic = await polygon.deployToken(
//     'wrapped Matic',
//     'wMatic',
//     6,
...
//   const movr = await moonriver.deployToken(
//     'wrapped Moonriver',
//     'wMOVR',
//     6,
//     BigInt(100_000_000e6)
...
//   const moonriverNFTDummy = await deployNFT(
//     moonriverDeployer,
//     'https://www.example2.com'
//   )

//   const lender = moonriver.userWallets[1]
//   const firstNFTOnMoonriver = await (
//     await moonriverNFTDummy.connect(lender).mint()
//   ).wait(1)

//   const renter = polygon.userWallets[1]
//   await polygon.giveToken(renter.address, 'wMATIC', BigInt(100e6))

//   const approveTx = await moonriverNFTDummy
//     .connect(lender)
//     .approve(moonriverMarketPlace.address, 0)
