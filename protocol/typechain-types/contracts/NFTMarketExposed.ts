...
export interface NFTMarketExposedInterface extends utils.Interface {
  functions: {
    ...
    "updateListing(address,uint256,address,uint16)": FunctionFragment;
    "verifyPayment(address,(address,uint256),(address,uint256),uint16)": FunctionFragment;
    "verifyRentConditions(address,uint256,uint16)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "verifyRentConditions",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>
...
export interface NFTMarketExposed extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTMarketExposedInterface;
